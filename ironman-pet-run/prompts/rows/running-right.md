Create one horizontal animation strip for Codex pet `ironman`, state `running-right`.
...
Identity: same pet in every frame: Iron Man-inspired compact armored superhero mascot: glossy red-and-gold sci-fi armor, cyan circular chest reactor and narrow glowing cyan eye slits, friendly confident expression, chibi 3D toy style, no text, logos, weaponry, or trademarks.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: High-readability chibi armored figure; keep the circular cyan chest reactor, red-and-gold armor panels, and expressive helmet eye slits consistent; use a flat magenta chroma background..
